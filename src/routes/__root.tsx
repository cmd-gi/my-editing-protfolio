...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Charan is a video editor, colorist, motion graphics designer and AI creative specialist crafting cinematic visual experiences for brands and storytellers." },
      { name: "author", content: "Charan" },
      { name: "keywords", content: "video editor portfolio, colorist, motion graphics designer, AI video creator, DaVinci Resolve, After Effects, cinematic editing" },
